...
STRIP = strip
VERSION = 1.0
abs_builddir = /Users/jagiella/Dropbox/Work/CODE/libnix
abs_srcdir = /Users/jagiella/Dropbox/Work/CODE/libnix
...
top_builddir = .
top_srcdir = .
SUBDIRS = src src/tumor3d src/bin_abc src/lunatick src/segmentation
